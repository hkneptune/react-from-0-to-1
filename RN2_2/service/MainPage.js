...
import S23View from './Views/S23View';
import S24View from './Views/S24View';
import S25View from './Views/S25View';
        ...
        return(
            <ScrollView>
                ...
                <TouchableOpacity onPress={this._onPress.bind(this, S22View)}>
                    <Text style={styles.text}>场景22：iOS打包</Text>
                </TouchableOpacity>

                <TouchableOpacity onPress={this._onPress.bind(this, S23View)}>
                    <Text style={styles.text}>场景23：Android打包</Text>
                </TouchableOpacity>

                <TouchableOpacity onPress={this._onPress.bind(this, S24View)}>
                    <Text style={styles.text}>场景24：iOS持久化</Text>
                </TouchableOpacity>

                <TouchableOpacity onPress={this._onPress.bind(this, S25View)}>
                    <Text style={styles.text}>场景25：Android持久化</Text>
                </TouchableOpacity>
            </ScrollView>
         );
    }
